(function() {
  var CSON, Command, Git, Install, RebuildModuleCache, assert, async, config, fs, hostedGitInfo, isDeprecatedPackage, path, request, semver, temp, yargs, _,
  ...
  module.exports = Install = (function(_super) {
    ...
    function Install() {
      this.installGitPackageDependencies = __bind(this.installGitPackageDependencies, this);
    ...
    Install.prototype.installModules = function(options, callback) {
      ...
      return this.forkInstallCommand(options, (function(_this) {
        return function() {
          ...
          if (options.argv.json) {
            return _this.logCommandResultsIfFail.apply(_this, [callback].concat(__slice.call(args)));
          } else {
      ...
      return this.requestPackage(packageName, (function(_this) {
        return function(error, pack) {
          ...
          if (error != null) {
            ...
            commands.push(function(_arg, next) {
              var installPath, json;
              installPath = _arg.installPath;
              if (installPath != null) {
