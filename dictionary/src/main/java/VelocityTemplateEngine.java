...
layout.vtl File
We can also create our basic layout.vtl file now. Remember, as we learned in this lesson this is the basic HTML that will be loaded for every page of our application. It contains the standard HTML tags, a link to Bootstrap, and the line #parse( $template ) where the Velocity Template Engine will render the unique HTML individual pages:
